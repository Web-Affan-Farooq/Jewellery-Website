  ...
  return (
    <section className='text-center w-full p-5 flex flex-row flex-wrap justify-center items-center gap-5 '>
      <div className='w-[350px] p-3 bg-customgray rounded-md'>
        ...
        <h2 className='text-[20px] font-bold leading-10'>Shipping Worldwide</h2>
        <p className='text-[13px] w-40 text-center m-auto'>  kjfd lorem fhdjhf dfjdhfd fjdhfjd fdjfhjd fdhf</p>
      </div>
      <div className='w-[350px] p-3 bg-customgray rounded-md'>
